...
1. Build: link **OpenSSL libcrypto** and **libsecp256k1**; add
   ...
   The library that gains these deps is the engine library `libsecstore`
   (unchanged name; FEAT-231 adds the separate `libsecstore-client`,
   which stays crypto-free).
